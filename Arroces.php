...
?>
  ...
  <div class="row">
    ...
    <div class="col-sm-2 cajachoco">
     ...
     <ul>
        <img class="imgcajas" alt="Pollos" src="fotos/arroz-carne.jpg">
     </ul>  
    </div>
    ...
    <div class="col-sm-4  cajachoco">
     ...
     <ul>
        <img class="imgcajas" alt="Pollos" src="fotos/arroz-pescado.jpg">
     </ul>  
    </div>
  </div>
...
<div class="row">
    ...
    <div class="col-sm-2 cajachoco">
     ...
     <ul>
        <img class="imgcajas" alt="Pollos" src="fotos/arroz-caldoso.jpg">
     </ul>  
    </div>
    ...
    <div class="col-sm-2 cajachoco">
     ...
     <ul>
        <img class="imgcajas" alt="Pollos" src="fotos/arroz-verduras.jpg">
     </ul>  
    </div>
  </div>
