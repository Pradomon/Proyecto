...
?>
  ...
  <div class="row">
    ...
    <div class="col-sm-2 cajachoco">
     ...
     <ul>
        <img class="imgcajas" alt="Pollos" src="fotos/pollo-despiece.png">
     </ul>  
    </div>
    ...
    <div class="col-sm-2 cajachoco">
     ...
     <ul>
        <img class="imgcajas" alt="Ternera" src="fotos/ternera.jpg">
     </ul>  
    </div>
...
<div class="row">
    ...
    <div class="col-sm-2  cajachoco">
     ...
     <ul>
        <img class="imgcajas" alt="cordero" src="fotos/cordero.jpg">
     </ul>  
    </div>
  ...
  <div class="col-sm-2 cajachoco">
     ...
     <ul>
        <img class="imgcajas" alt="cerdo" src="fotos/cerdo.jpg">
     </ul>  
    </div>
